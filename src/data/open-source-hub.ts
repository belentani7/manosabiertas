...
export const GITHUB_REPOS: GitHubRepo[] = [
  ...
  { id: 'gh-27', name: 'stable-diffusion', owner: 'Stability-AI', url: 'https://github.com/Stability-AI/generative-models', description: 'Generador de imágenes con IA, open-source.', category: 'ai-ml', language: 'Python', stars: '40k+', difficulty: 'advanced', topics: ['Image Generation', 'Stable Diffusion', 'Open Source'], hasTutorial: true },
  ...
  // More web dev
  { id: 'gh-41', name: 'Awesome-Spanish-Dev', owner: 'andresf01', url: 'https://github.com/Acadeller/recursos-programacion', description: 'Recursos para developers hispanohablantes.', category: 'education', language: 'Markdown', stars: '2k+', difficulty: 'beginner', topics: ['Spanish', 'Development', 'Resources'], hasTutorial: false },
  { id: 'gh-42', name: 'computer-science-open-textbooks', owner: 'OPMatters', url: 'https://github.com/EbookFoundation/free-programming-books', description: 'Libros de texto abiertos de informática.', category: 'education', language: 'Markdown', stars: '1k+', difficulty: 'intermediate', topics: ['CS', 'Textbooks', 'Open'], hasTutorial: false },
  ...
  { id: 'gh-46', name: 'free-certifications', owner: 'cloudcommunity', url: 'https://github.com/freeCodeCamp/freeCodeCamp', description: 'Lista de certificaciones tecnológicas gratuitas.', category: 'education', language: 'Markdown', stars: '3k+', difficulty: 'beginner', topics: ['Certifications', 'Free', 'Tech'], hasTutorial: false },
