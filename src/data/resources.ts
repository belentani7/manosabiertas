...
const nationalGov: Resource[] = [
  { id: 'nat-1', title: 'Portal de Inmigración - Gobierno de España', description: 'Portal oficial con toda la información sobre extranjería e inmigración.', url: 'https://www.exteriores.gob.es/es/', category: 'government', region: 'national', source: 'Ministerio de Asuntos Exteriores', tags: ['inmigración','extranjería'], free: true },
  ...
  { id: 'nat-13', title: 'Cita Previa Policía - Extranjería', description: 'Cita para huellas y autorizaciones de residencia.', url: 'https://www.policia.es/', category: 'documentation', region: 'national', source: 'Policía Nacional', tags: ['huellas','residencia'], free: true },
  ...
  { id: 'nat-22', title: 'Renta Web - Campaña IRPF', description: 'Declaración de la renta anual online.', url: 'https://sede.agenciatributaria.gob.es/Sede/Renta.html', category: 'government', region: 'national', source: 'AEAT', tags: ['renta','IRPF'], free: true },
  ...
  { id: 'nat-24', title: 'Observatorio Permanente de la Inmigración', description: 'Estadísticas e informes sobre inmigración en España.', url: 'https://www.inclusion.gob.es/w/observatorio-permanente-de-la-inmigracion', category: 'government', region: 'national', source: 'MITESMI', tags: ['estadísticas','inmigración'], free: true },
  { id: 'nat-25', title: 'Centro Nacional de Inmigración (CENI)', description: 'Centro nacional de información sobre inmigración.', url: 'https://www.inclusion.gob.es/web/migraciones/vivir-en-espana', category: 'government', region: 'national', source: 'MITESMI', tags: ['información'], free: true },
  ...
  { id: 'nat-33', title: 'SEPE - Prestación por Desempleo', description: 'Información sobre el paro: requisitos, duración y cuantía.', url: 'https://www.sepe.es/HomeSepe/prestaciones-desempleo/prestacion-contributiva.html', category: 'work', region: 'national', source: 'SEPE', tags: ['paro','desempleo'], free: true },
  { id: 'nat-34', title: 'SEPE - Renta Activa de Inserción (RAI)', description: 'Ayuda para desempleados de larga duración mayores de 45.', url: 'https://www.sepe.es/HomeSepe/prestaciones-desempleo/subsidio-desempleo.html', category: 'work', region: 'national', source: 'SEPE', tags: ['RAI','desempleo'], free: true },
  { id: 'nat-35', title: 'SEPE - Formación Profesional para el Empleo', description: 'Cursos gratuitos para mejorar tu empleabilidad.', url: 'https://www.sepe.es/HomeSepe/formacion-trabajo/catalogo-especialidades-formativas.html', category: 'education', region: 'national', source: 'SEPE', tags: ['cursos','FP'], free: true },
  ...
  { id: 'nat-44', title: 'Registro Civil Electrónico', description: 'Inscripción de nacimientos, matrimonios, defunciones online.', url: 'https://www.mjusticia.gob.es/es/ciudadania/estado-civil/registro-civil', category: 'documentation', region: 'national', source: 'Ministerio de Justicia', tags: ['registro civil'], free: true },
  ...
  { id: 'nat-46', title: 'Nacionalidad Española - Ministerio de Justicia', description: 'Cómo obtener la nacionalidad española por residencia u opción.', url: 'https://www.mjusticia.gob.es/es/ciudadania/nacionalidad', category: 'legal', region: 'national', source: 'Ministerio de Justicia', tags: ['nacionalidad','ciudadanía'], free: true },
  { id: 'nat-47', title: 'Asistencia Jurídica Gratuita', description: 'Abogado de oficio gratuito para personas con bajos ingresos.', url: 'https://www.mjusticia.gob.es/es/ciudadania/tramites/asistencia-juridica-gratuita', category: 'legal', region: 'national', source: 'Ministerio de Justicia', tags: ['abogado de oficio','justicia gratuita'], free: true },
  ...
  { id: 'nat-55', title: 'Carné por Puntos - Consulta', description: 'Consulta de puntos del carné de conducir.', url: 'https://www.dgt.es/', category: 'documentation', region: 'national', source: 'DGT', tags: ['carné','puntos'], free: true },
  ...
  { id: 'nat-58', title: 'Atención a la Dependencia', description: 'Información sobre la Ley de Dependencia y prestaciones.', url: 'https://imserso.es/autonomia-personal-dependencia', category: 'government', region: 'national', source: 'Imserso', tags: ['dependencia','cuidados'], free: true },
  ...
  { id: 'nat-73', title: '016 - Violencia de Género', description: 'Teléfono gratuito y confidencial de ayuda a víctimas (016).', url: 'https://violenciagenero.igualdad.gob.es/informacion-3/recursos/telefono016/', category: 'emergency', region: 'national', source: 'Delegación del Gobierno', tags: ['violencia','016','mujeres'], free: true },
  ...
  { id: 'nat-75', title: 'Ayuda a Víctimas de Trata', description: 'Recursos para víctimas de trata de seres humanos.', url: 'https://www.policia.es/', category: 'legal', region: 'national', source: 'Policía Nacional', tags: ['trata','víctimas'], free: true },
  { id: 'nat-76', title: 'Red de Casas de Acogida', description: 'Recursos de acogida para mujeres víctimas de violencia.', url: 'https://violenciagenero.igualdad.gob.es/informacion-3/recursos/', category: 'housing', region: 'national', source: 'Delegación del Gobierno', tags: ['acogida','mujeres'], free: true },
  ...
  { id: 'nat-79', title: 'Catastro - Referencia Catastral', description: 'Obtén la referencia catastral de tu vivienda.', url: 'https://www.sedecatastro.gob.es/', category: 'documentation', region: 'national', source: 'Catastro', tags: ['catastro'], free: true },
  ...
  { id: 'nat-81', title: 'Código de la Propiedad Horizontal', description: 'Normativa legal sobre comunidades de vecinos.', url: 'https://www.boe.es/buscar/', category: 'housing', region: 'national', source: 'BOE', tags: ['comunidad','vecinos'], free: true },
  ...
  { id: 'nat-83', title: 'Banco de España - Ciudadanía', description: 'Información financiera y educativa del BdE.', url: 'https://clientebancario.bde.es/pcb/es/', category: 'banking', region: 'national', source: 'Banco de España', tags: ['finanzas','educación'], free: true },
  ...
  { id: 'nat-86', title: 'RECLAMA - Sistema Arbitral de Consumo', description: 'Sistema arbitral gratuito para resolver disputas de consumo.', url: 'https://www.dsca.gob.es/es/consumo/como-reclamar-conflicto-consumo/sistema-arbitral-consumo', category: 'legal', region: 'national', source: 'Ministerio de Consumo', tags: ['arbitraje','consumo'], free: true },
  ...
  { id: 'nat-93', title: 'Crea tu Empresa - PAE', description: 'Puntos de Atención al Emprendedor para crear empresas.', url: 'https://ipyme.org/', category: 'work', region: 'national', source: 'Red.es', tags: ['empresa','PAE'], free: true },
  ...
  { id: 'nat-95', title: 'SEPE - Catálogo de Ocupaciones', description: 'Catálogo oficial de ocupaciones y competencias.', url: 'https://www.sepe.es/HomeSepe/empresas/informacion-para-empresas/profesiones-de-dificil-cobertura/profesiones-mas-demandadas.html', category: 'work', region: 'national', source: 'SEPE', tags: ['ocupaciones'], free: true },
  ...
  { id: 'nat-103', title: 'Sanidad Universal - Información', description: 'Información sobre el derecho a la sanidad universal.', url: 'https://www.sanidad.gob.es/profesionales/prestacionesSanitarias/CarteraDeServicios/AccesoUsuariosCS/accesoUniversalSP.htm', category: 'health', region: 'national', source: 'Ministerio de Sanidad', tags: ['sanidad','universal'], free: true },
  { id: 'nat-104', title: 'Tarjeta Sanitaria - Solicitud', description: 'Cómo obtener la Tarjeta Sanitaria Individual (TSI).', url: 'https://www.sanidad.gob.es/profesionales/prestacionesSanitarias/CarteraDeServicios/AccesoUsuariosCS/accesoUniversalSP.htm', category: 'health', region: 'national', source: 'Ministerio de Sanidad', tags: ['TSI','tarjeta sanitaria'], free: true },
  { id: 'nat-105', title: 'Donación de Sangre - Información', description: 'Información sobre donación de sangre y centros.', url: 'https://sede.mscbs.gob.es/servicios/Ciudadanos/home.htm', category: 'health', region: 'national', source: 'Ministerio de Sanidad', tags: ['donación','sangre'], free: true },
  { id: 'nat-106', title: 'Vacunación Adultos', description: 'Calendario de vacunación para adultos.', url: 'https://www.sanidad.gob.es/areas/promocionPrevencion/vacunaciones/calendario/home.htm', category: 'health', region: 'national', source: 'Ministerio de Sanidad', tags: ['vacunas'], free: true },
...
const communities: CommunityData[] = [
  { id: 'andalucia', name: 'Andalucía', portal: 'https://www.juntadeandalucia.es/', immigrationUrl: 'https://www.juntadeandalucia.es/organismos/inclusionsocialjuventudfamiliaseigualdad/areas/inclusion/migraciones/paginas/inmigracion.html', employmentUrl: 'https://www.juntadeandalucia.es/organismos/sae.html', healthUrl: 'https://www.sspa.juntadeandalucia.es/', housingUrl: 'https://www.juntadeandalucia.es/organismos/viviendajuventudyordenaciondelterritorio/areas/vivienda-rehabilitacion.html', socialServicesUrl: 'https://www.juntadeandalucia.es/organismos/inclusionsocialjuventudfamiliaseigualdad.html', educationUrl: 'https://www.juntadeandalucia.es/educacion', consumerUrl: 'https://www.juntadeandalucia.es/organismos/presidenciasanidadyemergencias/areas/consumo.html', youthUrl: 'https://www.juntadeandalucia.es/organismos/iaj.html', womenUrl: 'https://www.juntadeandalucia.es/institutodelamujer' },
  { id: 'aragon', name: 'Aragón', portal: 'https://www.aragon.es/', immigrationUrl: 'https://www.aragon.es/temas/servicios-sociales/inmigracion', employmentUrl: 'https://www.aragon.es/temas/empleo-empresa-entidades', healthUrl: 'https://www.salud.aragon.es/', housingUrl: 'https://www.aragon.es/temas/vivienda-urbanismo', socialServicesUrl: 'https://www.aragon.es/temas/servicios-sociales', educationUrl: 'https://www.educaragon.org/', consumerUrl: 'https://www.aragon.es/temas/comercio-consumo/consumo', youthUrl: 'https://www.aragon.es/temas/servicios-sociales/juventud', womenUrl: 'https://www.aragon.es/temas/servicios-sociales/igualdad-no-discriminacion-diversidad' },
  { id: 'asturias', name: 'Principado de Asturias', portal: 'https://www.asturias.es/', immigrationUrl: 'https://www.asturias.es/temas/accion-social-e-igualdad', employmentUrl: 'https://www.asturias.es/temas/empleo', healthUrl: 'https://www.asturias.es/temas/salud', housingUrl: 'https://www.asturias.es/temas/vivienda-territorio', socialServicesUrl: 'https://www.asturias.es/temas/accion-social-e-igualdad', educationUrl: 'https://www.educastur.es/', consumerUrl: 'https://www.asturias.es/temas/comercio-consumo', youthUrl: 'https://juventud.asturias.es/', womenUrl: 'https://iam.asturias.es/' },
  { id: 'balears', name: 'Illes Balears', portal: 'https://www.caib.es/', immigrationUrl: 'https://www.caib.es/sites/inmigracio/ca/inici/', employmentUrl: 'https://www.caib.es/sites/empleo/ca/inici/', healthUrl: 'https://www.caib.es/sites/ibsalut/ca/inici/', housingUrl: 'https://www.caib.es/sites/habitatge/ca/inici/', socialServicesUrl: 'https://www.caib.es/sites/serveisocials/ca/inici/', educationUrl: 'https://www.caib.es/sites/educacio/ca/inici/', consumerUrl: 'https://www.caib.es/sites/consum/ca/inici/', youthUrl: 'https://www.caib.es/sites/ibjovent/ca/inici/', womenUrl: 'https://www.caib.es/sites/ibdona/es/instituto_balear_de_la_mujer_ibdona/' },
  { id: 'canarias', name: 'Canarias', portal: 'https://www.gobiernodecanarias.org/', immigrationUrl: 'https://www.gobiernodecanarias.org/bienestarsocial/inmigracion/', employmentUrl: 'https://www.gobiernodecanarias.org/empleo/', healthUrl: 'https://www.gobiernodecanarias.org/sanidad/', housingUrl: 'https://www.gobiernodecanarias.org/vivienda/', socialServicesUrl: 'https://www.gobiernodecanarias.org/bienestarsocial/servicios-sociales/index.html', educationUrl: 'https://www.gobiernodecanarias.org/educacion/', consumerUrl: 'https://www.gobiernodecanarias.org/consumo/', youthUrl: 'https://www.gobiernodecanarias.org/juventud/', womenUrl: 'https://www.gobiernodecanarias.org/igualdad/' },
  { id: 'cantabria', name: 'Cantabria', portal: 'https://www.cantabria.es/', immigrationUrl: 'https://www.cantabria.es/web/consejeria-de-empleo-y-politicas-sociales', employmentUrl: 'https://www.cantabria.es/trabajo-empleo', healthUrl: 'https://www.cantabria.es/sanidad', housingUrl: 'https://www.viviendadecantabria.es/', socialServicesUrl: 'https://www.serviciossocialescantabria.org/', educationUrl: 'https://www.cantabria.es/educacion', consumerUrl: 'https://www.cantabria.es/economia', youthUrl: 'https://www.cantabria.es/juventud', womenUrl: 'https://mujerdecantabria.es/' },
  { id: 'castilla-la-mancha', name: 'Castilla-La Mancha', portal: 'https://www.castillalamancha.es/', immigrationUrl: 'https://bienestarsocial.castillalamancha.es/cooperacion-actuaciones', employmentUrl: 'https://empleoyformacion.castillalamancha.es/', healthUrl: 'https://sanidad.castillalamancha.es/', housingUrl: 'https://vivienda.castillalamancha.es/', socialServicesUrl: 'https://bienestarsocial.castillalamancha.es/', educationUrl: 'https://www.educa.jccm.es/', consumerUrl: 'https://consumo.castillalamancha.es/', youthUrl: 'https://juventud.castillalamancha.es/', womenUrl: 'https://www.castillalamancha.es/temas/igualdad' },
  { id: 'castilla-y-leon', name: 'Castilla y León', portal: 'https://www.jcyl.es/', immigrationUrl: 'https://www.jcyl.es/', employmentUrl: 'https://www.ecyl.es/', healthUrl: 'https://www.saludcastillayleon.es/', housingUrl: 'https://www.jcyl.es/', socialServicesUrl: 'https://www.jcyl.es/', educationUrl: 'https://www.educa.jcyl.es/', consumerUrl: 'https://www.consumocyL.es/', youthUrl: 'https://www.jcyl.es/', womenUrl: 'https://www.jcyl.es/' },
  { id: 'cataluna', name: 'Catalunya', portal: 'https://web.gencat.cat/', immigrationUrl: 'https://dretssocials.gencat.cat/ca/ambits_tematics/migracions-refugi/', employmentUrl: 'https://treball.gencat.cat/', healthUrl: 'https://catsalut.gencat.cat/', housingUrl: 'https://habitatge.gencat.cat/', socialServicesUrl: 'https://dretssocials.gencat.cat/ca/ambits_tematics/serveis_socials/', educationUrl: 'https://educacio.gencat.cat/', consumerUrl: 'https://consum.gencat.cat/', youthUrl: 'https://joventut.gencat.cat/', womenUrl: 'https://igualtat.gencat.cat/' },
  { id: 'comunidad-valenciana', name: 'Comunitat Valenciana', portal: 'https://www.gva.es/', immigrationUrl: 'https://sede.gva.es/es/detall-tramit?id_proc=G12016', employmentUrl: 'https://labora.gva.es/es/inici', healthUrl: 'https://san.gva.es/es/', housingUrl: 'https://habitatge.gva.es/es/', socialServicesUrl: 'https://serviciossociales.gva.es/es/', educationUrl: 'https://www.ceice.gva.es/', consumerUrl: 'https://cindi.gva.es/es/', youthUrl: 'https://ivaj.gva.es/es/inici', womenUrl: 'https://habitatge.gva.es/es/web/igualtat-i-institut-de-les-dones/inici' },
  { id: 'extremadura', name: 'Extremadura', portal: 'https://www.juntaex.es/', immigrationUrl: 'https://www.juntaex.es/lajunta/presidencia/secretaria-general-de-igualdad-y-conciliacion', employmentUrl: 'https://www.juntaex.es/lajunta/consejeria-de-economia-empleo-y-transformacion-digital', healthUrl: 'https://www.saludextremadura.com/', housingUrl: 'https://www.juntaex.es/temas/vivienda', socialServicesUrl: 'https://www.juntaex.es/lajunta/presidencia/secretaria-general-de-igualdad-y-conciliacion', educationUrl: 'https://www.educarex.es/', consumerUrl: 'https://www.juntaex.es/lajunta/consejeria-de-salud-y-atencion-a-la-dependencia', youthUrl: 'https://www.juntaex.es/lajunta/consejeria-de-cultura-turismo-y-deportes', womenUrl: 'https://www.juntaex.es/imex' },
  { id: 'galicia', name: 'Galicia', portal: 'https://www.xunta.gal/', immigrationUrl: 'https://politicasocial.xunta.gal/es/temas/inclusion-social/inmigracion', employmentUrl: 'https://emprego.xunta.gal/es', healthUrl: 'https://www.sergas.es/', housingUrl: 'https://igvs.xunta.gal/es/areas/vivienda', socialServicesUrl: 'https://www.xunta.gal/politica-social/', educationUrl: 'https://www.edu.xunta.gal/', consumerUrl: 'https://consumo.xunta.gal/es', youthUrl: 'https://xuventude.xunta.gal/es', womenUrl: 'https://igualdade.xunta.gal/es' },
  ...
  { id: 'navarra', name: 'Comunidad Foral de Navarra', portal: 'https://www.navarra.es/', immigrationUrl: 'https://gobiernoabierto.navarra.es/es/gobernanza/planes-y-programas-accion-gobierno/plan-acogida-personas-migrantes-navarra-2021-2026', employmentUrl: 'https://www.navarra.es/es/empleo', healthUrl: 'https://www.navarra.es/es/salud', housingUrl: 'https://www.navarra.es/es/vivienda', socialServicesUrl: 'https://www.navarra.es/es/derechos-sociales', educationUrl: 'https://www.educacion.navarra.es/', consumerUrl: 'https://www.navarra.es/es/consumo', youthUrl: 'https://www.navarra.es/es/juventud', womenUrl: 'https://www.igualdadnavarra.es/es/inicio' },
  { id: 'pais-vasco', name: 'Euskadi', portal: 'https://www.euskadi.eus/', immigrationUrl: 'https://www.euskadi.eus/gobierno-vasco/acogida-integracion/inicio/', employmentUrl: 'https://www.euskadi.eus/gobierno-vasco/departamento-trabajo-empleo/', healthUrl: 'https://www.euskadi.eus/temas/-/salud/', housingUrl: 'https://www.euskadi.eus/temas/-/vivienda/', socialServicesUrl: 'https://www.euskadi.eus/serviciossociales/', educationUrl: 'https://www.euskadi.eus/educacion/', consumerUrl: 'https://www.euskadi.eus/consumo/', youthUrl: 'https://www.gazteaukera.euskadi.eus/', womenUrl: 'https://www.emakunde.euskadi.eus/inicio/' },
];
...
const cvTools: Resource[] = [
  ...
  { id: 'cv-19', title: 'SEPE - Orientación Laboral', description: 'Recursos oficiales para crear tu CV y buscar empleo.', url: 'https://www.sepe.es/HomeSepe/Personas/encontrar-trabajo/orientacion-profesional.html', category: 'cv-tools', region: 'national', source: 'SEPE', tags: ['CV','empleo'], free: true },
...
const officeLearning: Resource[] = [
  { id: 'off-1', title: 'Microsoft Learn - Word', description: 'Curso oficial de Microsoft Word, gratuito y certificado.', url: 'https://learn.microsoft.com/es-es/training/browse/?terms=word', category: 'office-learning', region: 'national', source: 'Microsoft', tags: ['Word','curso'], free: true },
  { id: 'off-2', title: 'Microsoft Learn - Excel', description: 'Aprende Excel desde cero hasta nivel experto, oficial y gratis.', url: 'https://learn.microsoft.com/es-es/training/browse/?terms=excel', category: 'office-learning', region: 'national', source: 'Microsoft', tags: ['Excel','curso'], free: true },
  { id: 'off-3', title: 'Microsoft Learn - PowerPoint', description: 'Curso oficial de PowerPoint de Microsoft.', url: 'https://learn.microsoft.com/es-es/training/browse/?terms=powerpoint', category: 'office-learning', region: 'national', source: 'Microsoft', tags: ['PowerPoint','curso'], free: true },
  { id: 'off-4', title: 'Microsoft Learn - Outlook', description: 'Aprende a usar Outlook de forma profesional.', url: 'https://learn.microsoft.com/es-es/training/browse/?terms=outlook', category: 'office-learning', region: 'national', source: 'Microsoft', tags: ['Outlook','curso'], free: true },
  ...
  { id: 'off-19', title: 'Word Básico - AulaFácil', description: 'Curso gratuito de Word paso a paso.', url: 'https://www.aulafacil.com/cursos/excel-word-powerpoint-access/word-2010-t2511', category: 'office-learning', region: 'national', source: 'AulaFácil', tags: ['Word','curso'], free: true },
  { id: 'off-20', title: 'Excel Básico - AulaFácil', description: 'Curso gratuito de Excel paso a paso.', url: 'https://www.aulafacil.com/cursos/excel-word-powerpoint-access/excel-2010-basico-t6206', category: 'office-learning', region: 'national', source: 'AulaFácil', tags: ['Excel','curso'], free: true },
  { id: 'off-21', title: 'PowerPoint Básico - AulaFácil', description: 'Curso gratuito de PowerPoint.', url: 'https://www.aulafacil.com/articulos/curso-recomendado/power-point-t733', category: 'office-learning', region: 'national', source: 'AulaFácil', tags: ['PowerPoint','curso'], free: true },
...
const githubRepos: Resource[] = [
  ...
  { id: 'gh-34', title: 'Awesome Resume', description: 'Recursos para crear tu CV técnico.', url: 'https://github.com/salomonelli/best-resume-ever', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['CV','resume'], free: true },
  ...
  { id: 'gh-37', title: 'Awesome Spanish Dev', description: 'Recursos para developers hispanohablantes.', url: 'https://github.com/Acadeller/recursos-programacion', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['español','dev'], free: true },
  ...
  { id: 'gh-45', title: 'Awesome GitHub Templates', description: 'Plantillas para perfiles y repos GitHub.', url: 'https://github.com/durgeshsamariya/awesome-github-profile-readme-templates', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['GitHub','plantillas'], free: true },
  ...
  { id: 'gh-48', title: 'Taller de Git', description: 'Repositorio en español para aprender Git.', url: 'https://github.com/platzi/git-github', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['Git','español'], free: true },
  { id: 'gh-49', title: 'Awesome Spanish', description: 'Recursos de programación en español.', url: 'https://github.com/GeiserX/awesome-spain', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['español','recursos'], free: true },
  { id: 'gh-50', title: 'Awesome Spanish Resources', description: 'Más recursos en español para devs.', url: 'https://github.com/Acadeller/recursos-programacion', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['español'], free: true },
  { id: 'gh-51', title: 'Awesome Excel', description: 'Recursos para aprender Excel.', url: 'https://github.com/brandonhimpfen/awesome-excel', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['Excel'], free: true },
  { id: 'gh-52', title: 'Excel-VBA-Course', description: 'Curso gratuito de VBA para Excel.', url: 'https://github.com/sancarn/awesome-vba', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['Excel','VBA'], free: true },
  { id: 'gh-53', title: 'Awesome Office', description: 'Recursos para Microsoft Office.', url: 'https://github.com/NajiElKotob/AwesomeMSO', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['Office'], free: true },
  { id: 'gh-54', title: 'Awesome PowerPoint', description: 'Plantillas y recursos para PowerPoint.', url: 'https://github.com/brandonhimpfen/awesome-powerpoint', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['PowerPoint'], free: true },
  ...
  { id: 'gh-56', title: 'Computer Science Open Textbooks', description: 'Libros de texto abiertos de informática.', url: 'https://github.com/EbookFoundation/free-programming-books', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['libros','universidad'], free: true },
  { id: 'gh-57', title: 'Awesome Cybersecurity', description: 'Recursos de ciberseguridad gratis.', url: 'https://github.com/Hack-with-Github/Awesome-Hacking', category: 'github-learning', region: 'national', source: 'GitHub', tags: ['ciberseguridad'], free: true },
...
const employmentResources: Resource[] = [
  ...
  { id: 'emp-11', title: 'Empleo Públicos - Portal', description: 'Ofertas de empleo público en España.', url: 'https://administracion.gob.es/', category: 'work', region: 'national', source: 'AGE', tags: ['empleo público'], free: true },
...
const bankingResources: Resource[] = [
  ...
  { id: 'bnk-27', title: 'CaixaBank - Cuenta No Residentes', description: 'Cuenta pensada para no residentes en España.', url: 'https://www.caixabank.es/particular/cuentas/cuenta-extranjeros.html', category: 'banking', region: 'national', source: 'CaixaBank', tags: ['no residente'], free: false },
  ...
  { id: 'bnk-29', title: 'Banco Español de Crédito Social', description: 'Cuenta básica bancaria con tarifa máxima 3€/mes (Real Decreto).', url: 'https://clientebancario.bde.es/pcb/es/', category: 'banking', region: 'national', source: 'Banco de España', tags: ['cuenta básica','social'], free: false },
  ...
  { id: 'bnk-38', title: 'CNMC - Reclamaciones Bancarias', description: 'Cómo presentar reclamaciones a tu banco.', url: 'https://sede.cnmc.gob.es/tramites/competencia/denuncia-de-conducta-prohibida', category: 'banking', region: 'national', source: 'CNMC', tags: ['reclamaciones'], free: true },
  { id: 'bnk-39', title: 'Banco de España - Reclamaciones', description: 'Servicio de reclamaciones del Banco de España.', url: 'https://clientebancario.bde.es/pcb/es/', category: 'banking', region: 'national', source: 'BdE', tags: ['reclamaciones'], free: true },
...
const languageLearning: Resource[] = [
  ...
  { id: 'lng-31', title: 'TED en Español', description: 'Charlas motivacionales en español, con subtítulos.', url: 'https://www.ted.com/', category: 'language-learning', region: 'national', source: 'TED', tags: ['charlas','audio'], free: true },
  ...
  { id: 'lng-33', title: 'RTVE - Aprende Español', description: 'Recursos de RTVE para aprender español.', url: 'https://www.rtve.es/', category: 'language-learning', region: 'national', source: 'RTVE', tags: ['español','recursos'], free: true },
...
const healthResources: Resource[] = [
  ...
  { id: 'hlt-5', title: 'Tarjeta Sanitaria Individual (TSI)', description: 'Cómo obtener la tarjeta sanitaria.', url: 'https://www.sanidad.gob.es/profesionales/prestacionesSanitarias/CarteraDeServicios/AccesoUsuariosCS/accesoUniversalSP.htm', category: 'health', region: 'national', source: 'Sanidad', tags: ['TSI','tarjeta'], free: true },
  { id: 'hlt-6', title: 'Vacunación COVID-19', description: 'Información oficial sobre vacunación.', url: 'https://www.sanidad.gob.es/areas/alertasEmergenciasSanitarias/alertasActuales/nCov/home.htm', category: 'health', region: 'national', source: 'Sanidad', tags: ['vacunación','covid'], free: true },
  { id: 'hlt-7', title: 'Calendario Vacunal España', description: 'Calendario oficial de vacunación para todas las edades.', url: 'https://www.sanidad.gob.es/areas/promocionPrevencion/vacunaciones/calendario/home.htm', category: 'health', region: 'national', source: 'Sanidad', tags: ['vacunas','calendario'], free: true },
  ...
  { id: 'hlt-10', title: 'Salud Mental - Ministerio', description: 'Estrategia de salud mental del Ministerio.', url: 'https://www.sanidad.gob.es/areas/calidadAsistencial/estrategias/saludMental/home.htm', category: 'health', region: 'national', source: 'Sanidad', tags: ['salud mental'], free: true },
  ...
  { id: 'hlt-17', title: 'Centro de Salud - Buscador', description: 'Encuentra tu centro de salud más cercano.', url: 'https://www.sanidad.gob.es/servCiudadanos/home.htm', category: 'health', region: 'national', source: 'Sanidad', tags: ['centro salud'], free: true },
  { id: 'hlt-18', title: 'Salud de la Mujer', description: 'Programa de salud de la mujer del Ministerio.', url: 'https://observatoriosaludmujeres.sanidad.gob.es/', category: 'health', region: 'national', source: 'Sanidad', tags: ['mujer','salud'], free: true },
  { id: 'hlt-19', title: 'Salud Infantil', description: 'Programa de salud infantil y adolescente.', url: 'https://www.sanidad.gob.es/areas/promocionPrevencion/infanciaAdolescencia/infancia/home.htm', category: 'health', region: 'national', source: 'Sanidad', tags: ['infancia'], free: true },
...
const familyResources: Resource[] = [
  ...
  { id: 'fam-8', title: '016 - Violencia de Género', description: 'Teléfono gratuito de ayuda a víctimas de violencia de género.', url: 'https://violenciagenero.igualdad.gob.es/informacion-3/recursos/telefono016/', category: 'emergency', region: 'national', source: 'Igualdad', tags: ['016','violencia'], free: true },
  ...
  { id: 'fam-10', title: 'MENAS - Menores Extranjeros', description: 'Recursos para menores extranjeros no acompañados.', url: 'https://www.inclusion.gob.es/web/migraciones/vivir-en-espana', category: 'family', region: 'national', source: 'MITESMI', tags: ['MENAS','menores'], free: true },
  ...
  { id: 'fam-40', title: 'Adopción Internacional', description: 'Información sobre adopción internacional.', url: 'https://www.mjusticia.gob.es/es/ciudadania/registros', category: 'family', region: 'national', source: 'Justicia', tags: ['adopción'], free: true },
];
...
const transportResources: Resource[] = [
  ...
  { id: 'trn-24', title: 'Aeropuerto Madrid-Barajas', description: 'Aeropuerto Adolfo Suárez Madrid-Barajas.', url: 'https://www.aena.es/', category: 'transport', region: 'madrid', source: 'AENA', tags: ['aeropuerto','madrid'], free: false },
  { id: 'trn-25', title: 'Aeropuerto Barcelona-El Prat', description: 'Aeropuerto Josep Tarradellas Barcelona-El Prat.', url: 'https://www.aena.es/', category: 'transport', region: 'cataluna', source: 'AENA', tags: ['aeropuerto','barcelona'], free: false },
  ...
  { id: 'trn-38', title: 'DGT - Carreteras Estado', description: 'Estado de las carreteras del Estado.', url: 'https://www.dgt.es/', category: 'transport', region: 'national', source: 'DGT', tags: ['carreteras'], free: true },
...
const housingResources: Resource[] = [
  ...
  { id: 'hse-12', title: 'AVRA - Andalucía Vivienda', description: 'Agencia de vivienda y rehabilitación de Andalucía.', url: 'https://www.juntadeandalucia.es/organismos/viviendajuventudyordenaciondelterritorio/areas/vivienda-rehabilitacion.html', category: 'housing', region: 'andalucia', source: 'AVRA', tags: ['vivienda','andalucía'], free: true },
  ...
  { id: 'hse-15', title: 'IVSA - Valencia', description: 'Instituto Valenciano de Suelo y Vivienda.', url: 'https://habitatge.gva.es/es/', category: 'housing', region: 'comunidad-valenciana', source: 'IVSA', tags: ['vivienda','valencia'], free: true },
  { id: 'hse-16', title: 'AVIS - Sevilla', description: 'Agencia de Vivienda y Rehabilitación de Sevilla.', url: 'https://www.juntadeandalucia.es/organismos/viviendajuventudyordenaciondelterritorio/areas/vivienda-rehabilitacion.html', category: 'housing', region: 'andalucia', source: 'AVIS', tags: ['vivienda'], free: true },
  ...
  { id: 'hse-22', title: 'Fianza - Depositaria', description: 'Información sobre depósito de fianzas.', url: 'https://www.comunidad.madrid/', category: 'housing', region: 'madrid', source: 'Comunidad Madrid', tags: ['fianza'], free: true },
  ...
  { id: 'hse-27', title: 'Abogados - Desahucios Gratis', description: 'Asistencia jurídica gratuita ante desahucios.', url: 'https://www.mjusticia.gob.es/es/ciudadania/tramites/asistencia-juridica-gratuita', category: 'legal', region: 'national', source: 'Justicia', tags: ['desahucio','gratis'], free: true },
  { id: 'hse-28', title: 'ARABA - Vivienda Vasca', description: 'Vivienda pública del País Vasco.', url: 'https://www.euskadi.eus/temas/-/vivienda/', category: 'housing', region: 'pais-vasco', source: 'Gobierno Vasco', tags: ['vivienda','vasco'], free: true },
  ...
  { id: 'hse-30', title: 'Banco de España - Hipotecas', description: 'Guía oficial de hipotecas del BdE.', url: 'https://clientebancario.bde.es/pcb/es/', category: 'banking', region: 'national', source: 'BdE', tags: ['hipoteca','guía'], free: true },
];
...
const emergencyResources: Resource[] = [
  ...
  { id: 'emg-17', title: 'Embajada de Marruecos', description: 'Embajada de Marruecos en España: 91 319 19 99.', url: 'https://www.exteriores.gob.es/es/', category: 'emergency', region: 'national', source: 'Embajada Marruecos', tags: ['embajada','marruecos'], free: true },
  ...
  { id: 'emg-28', title: 'Embajada de Brasil', description: 'Embajada de Brasil en España.', url: 'https://www.gov.br/pt-br', category: 'emergency', region: 'national', source: 'Embajada Brasil', tags: ['embajada','brasil'], free: true },
...
const legalResources: Resource[] = [
  { id: 'lgl-1', title: 'Justicia Gratuita - Sede', description: 'Información sobre asistencia jurídica gratuita.', url: 'https://www.mjusticia.gob.es/es/ciudadania/tramites/asistencia-juridica-gratuita', category: 'legal', region: 'national', source: 'Justicia', tags: ['abogado de oficio','gratis'], free: true },
  ...
  { id: 'lgl-6', title: 'Ley de Extranjería (LO 4/2000)', description: 'Texto consolidado de la Ley de Extranjería.', url: 'https://www.boe.es/eli/es/lo/2000/01/11/4/con', category: 'legal', region: 'national', source: 'BOE', tags: ['extranjería','ley'], free: true },
  { id: 'lgl-7', title: 'Reglamento Extranjería', description: 'Reglamento de la Ley de Extranjería.', url: 'https://www.boe.es/eli/es/rd/2011/04/20/557/con', category: 'legal', region: 'national', source: 'BOE', tags: ['reglamento','extranjería'], free: true },
  ...
  { id: 'lgl-9', title: 'Código Civil', description: 'Código Civil de España.', url: 'https://www.boe.es/eli/es/rd/1889/07/24/(1)/con', category: 'legal', region: 'national', source: 'BOE', tags: ['civil','código'], free: true },
  { id: 'lgl-10', title: 'Ley de Igualdad', description: 'Ley Orgánica para la igualdad efectiva.', url: 'https://www.boe.es/eli/es/lo/2007/03/22/3/con', category: 'legal', region: 'national', source: 'BOE', tags: ['igualdad'], free: true },
  { id: 'lgl-11', title: 'Ley Dependencia', description: 'Ley de Promoción de la Autonomía Personal.', url: 'https://www.boe.es/eli/es/l/2006/12/14/39/con', category: 'legal', region: 'national', source: 'BOE', tags: ['dependencia'], free: true },
  { id: 'lgl-12', title: 'Ley Integración Inmigrantes', description: 'Ley orgánica de integración de inmigrantes.', url: 'https://www.boe.es/eli/es/lo/2000/01/11/4/con', category: 'legal', region: 'national', source: 'BOE', tags: ['integración','inmigración'], free: true },
  { id: 'lgl-13', title: 'Ley Asilo', description: 'Ley de Protección Internacional.', url: 'https://www.boe.es/eli/es/lo/2009/12/11/2', category: 'legal', region: 'national', source: 'BOE', tags: ['asilo','refugio'], free: true },
  ...
  { id: 'lgl-29', title: 'Nacionalidad - Sede Electrónica', description: 'Sede electrónica para trámites de nacionalidad.', url: 'https://www.mjusticia.gob.es/es/ciudadania/nacionalidad', category: 'legal', region: 'national', source: 'Justicia', tags: ['nacionalidad'], free: true },
...
const aiGuides: Resource[] = [
  ...
  { id: 'aig-16', title: 'Scikit-learn Tutorials', description: 'Aprende ML con scikit-learn.', url: 'https://scikit-learn.org/stable/', category: 'ai-tools', region: 'national', source: 'scikit-learn', tags: ['ML'], free: true },
  ...
  { id: 'aig-23', title: 'AWS Skill Builder', description: 'Formación gratis en cloud e IA de AWS.', url: 'https://aws.amazon.com/es/', category: 'ai-tools', region: 'national', source: 'AWS', tags: ['cloud','IA'], free: true },
